...
import com.yjkj.ks_user.service.BaseService;
import com.yjkj.ks_user.util.CommonUtil;
...
public abstract class BaseServiceImpl<T> implements BaseService<T> {
	...
	/*
	 * public String batchDelete(Object ids[]) { try { for (int i = 0; i <
	 * ids.length; i++) { delete(ids[i]); } } catch (Exception e) {
	 * logger.error("---batch error---", e); return ERROR; } return SUCCESS; }
	 */
